...
public class LootCrateDefinition {
        ...
        public FabricBlockSettings getChestBlockSettings() {
            FabricBlockSettings blockSettings = FabricBlockSettings.of(Material.METAL, materialColor).luminance(luminance).breakByTool(FabricToolTags.PICKAXES);;
        ...
        public FabricBlockSettings getShulkerBlockSettings() {
            FabricBlockSettings blockSettings = FabricBlockSettings.of(Material.SHULKER_BOX, materialColor).luminance(luminance).breakByTool(FabricToolTags.PICKAXES);;
